...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $contenido .= "<p>Presiona aquí: <a href='http://glacial-coast-70005.herokuapp.com/confirmar-cuenta?token=".$this->token."'>Confirmar Cuenta</a> <p>"; 
    ...
    public function enviarInstrucciones() {
        ...
        $contenido .= "<p>Presiona aquí: <a href='http://glacial-coast-70005.herokuapp.com/recuperar?token=".$this->token."'>Restablecer Password</a> <p>";
